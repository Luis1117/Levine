...
def my_plot_EavsV():
    ...
    for i in range(101):
        ...
        lr_Ln = np.polyfit(Ea_V[i, :][7:16, 10],
                           Ea_V[i, :][7:16, 8], 1, cov=True)
    ...
    Ea1395 = np.c_[dados, dados[:, 0]*8.61e-5, dados[:, 1]
    ...
    plt.title('Amostra 1395 (paso voltagem = 0.1V)')
    ...
    np.savetxt('Ea1394Mesa#3_Terra07MelhorRes.txt', Ea1395, delimiter=',')
    return plt.show()
