...
a = np.loadtxt('Ea1395Mesa#2_Terra07MelhorRes.txt', delimiter=',')
b = np.loadtxt('Ea1395Mesa#3_Terra07MelhorRes.txt', delimiter=',')
c = np.loadtxt('Ea1395Mesa#6_Terra07MelhorRes.txt', delimiter=',')
